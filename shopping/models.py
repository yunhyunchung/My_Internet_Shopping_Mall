...
class Piano(models.Model):
    ...
    # 가격
    price = models.CharField(max_length=30, help_text="'원' 빼고 숫자만 입력해주세요. ex) 395,000")

    # 별점
    star_rate = models.CharField(max_length=30, null=True, help_text="5점 만점입니다. 숫자 0~5 사이의 값을 입력해주세요.")
    # 제품 출시 년월
    release_date = models.DateTimeField(null=True, help_text="YYYY-MM-DD  |  ex) <em>2021-12-31</em>")
